...
public class SimpleCalculatorTest {
  ...
  /**
   * Test passing an operator as the first character, will give an illegalArgument Exception.
   */
  ...
  /**
   * Test two continuous operators, will give an Illegal argument exception.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Test Negative first character, will give an Illegal argument exception.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Test addition followed by multiplication., will give an Illegal argument exception.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  /**
   * Test two consecutive operators inputed, will give an illegal argument exception.
   */
  @Test(expected = IllegalArgumentException.class)
  ...
  public void testResultOverFlow() {
    ...
    assertEquals("45", c1.input('=').input('+').input('4').input('5').input('=').getResult());
  }
