 ...
 * placeholder for the actual data type.</p>
 */
public interface ListADT<T> {
  ...
  /**
   * Return an immutable list that contains the same data in the same sequence as this list.
   *
   * @return counterpart Immutable list that contains data in the same sequence as this list.
   */
  ListADT<T> toImmutable();

  /**
   * Return a Mutable list that contains the same data in the same sequence as this list.
   *
   * @return counterpart Mutable list that contains data in the same sequence as this list.
   */
  ListADT<T> toMutable();
